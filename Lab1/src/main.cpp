...
// สำหรับเวอร์ชั่นปกติที่ใช้ Serial.printf() ดูใน branch lect5
// https://github.com/zorone/CPE3423/blob/lect5/Lab1/src/main.cpp
...
void loop(){
  ...
  switch(state_current){
    ...
    case  0x01  :// decode
                  Serial.print("opcode: ");
                  Serial.print(program_mem[Reg_PC], HEX);
                  Serial.print(", PC: ");
                  Serial.print(Reg_PC, HEX);
                  Serial.println(" ");
